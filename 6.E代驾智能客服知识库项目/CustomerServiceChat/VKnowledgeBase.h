...
public:
	...
	bool execute(const std::string& sInputText, bool bNeedAnalysis,  std::string& sContext, Result_info& resultInfo, const std::string& sWay);
...
private:
	...
	void getRelatedQuestionEx(const std::vector<std::string>& words,Result_info& resultInfo,
																const int number =6);
private:
