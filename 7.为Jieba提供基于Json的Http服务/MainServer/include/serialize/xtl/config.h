 ...
 * MA 02111-1307, USA
 *
 * $Id: config.h,v 1.1.1.3 2008/07/04 03:11:24 lliu Exp $
 */
/*
 * 09 Sep 2000: Changed by Lutz Latta, lutz@latta.de
 *		Worked around the XTL_CONFIG_COMPOSITE_BUG on Win32
 */
...
#	pragma warning(disable:4127 4355 4786 4800)
...
#if defined(__alpha) || defined(__alpha__) || defined (_M_IX86)
#	ifndef __BYTE_ORDER
